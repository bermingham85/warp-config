...
1. **Check GitHub FIRST**
   ...
   ```
   - Search repos: `search_repositories` with user:bermingham85
   - Check recent commits: `list_commits`
...
3. **Check Related Repos**
   ...
   - Example: jesse-messy, jesse-messe, jesse-chapter-factory, jesse-novel-factory
...
- Report discrepancy to user if found
