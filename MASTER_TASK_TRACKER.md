...
- `BLUEPRINT` - Planned/designed but not built
...
|---------|--------|--------|--------------|-------|
| warp-config | PUSHED | [✓](https://github.com/bermingham85/warp-config) | 2026-02-05 | 36 rules, 1 skill |
| system-docs | PUSHED | [✓](https://github.com/bermingham85/system-docs) | 2026-02-05 | Rules review doc |
| master-prompt-library | PUSHED | [✓](https://github.com/bermingham85/master-prompt-library) | 2026-02-05 | Assessment prompt |
...
1. After completing work, update the relevant row
2. Change status appropriately
3. Update "Last Updated" date
4. Add notes if relevant
5. Commit to warp-config repo
